...
object english extends Translation {
  ...
  override val mapping: Map[String, String] = Map(
    ...
    "rune.surgical_precision" -> "Surgical Precision",
    "rune.measure" -> "Measure",
    "rune.unraveling" -> "Unraveling",
    "rune.inflexibility" -> "Inflexibility",
    "rune.steadfast" -> "Steadfast",
    "rune.iron_health" -> "Iron Health",
    "rune.positioning_science" -> "Positioning Science",
    "rune.anatomy" -> "Anatomy",
    "rune.brutality" -> "Brutality",
    "rune.herculean_strength" -> "Herculean Strength",
    "rune.brazier" -> "Brazier",
    "rune.smashmouth" -> "Smashmouth",
    "rune.alternation" -> "Alternation",
    "rune.confidence" -> "Confidence",
    "rune.powerhouse" -> "Powerhouse",
    "rune.alternation2" -> "Alternation II",
    "rune.excess" -> "Excess",
    "rune.blood_of_the_tear" -> "Blood of the tear",
    "rune.flames_aura" -> "Flames Aura",
    "rune.raised_guard" -> "Raised Guard",
